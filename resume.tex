...
\CVItem{CloudOps Engineer}{
  ...
  \begin{itemize}
    \item Modernized Auth0 client management via Terraform and Github Actions
    \item Owned and deployed internal business sites on Oracle Cloud Kubernetes
    \item Deployed SSO integrations for client applications via Auth0 and Google Workspace
    \item Improved security and build times for legacy repo build pipelines
    \item Integrated AWS Secrets Manager with CI pipelines for improved security
  \end{itemize}
}
