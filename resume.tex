...
\CVItem{DevOps Engineer}{
  ...
  \begin{itemize}
    \item Maintained cloud-native public Gitlab deployment in GKE and RKE2 on Azure
    ...
    \item Designed self-hosted RKE2 K8S cluster deployment architecture on Azure VMs
  \end{itemize}
}
