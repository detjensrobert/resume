...
\CVItem{DevOps Engineer}{
  ...
  \begin{itemize}
    ...
    \item Improved internal Gitlab Runner configuration by implementing secure rootless \\
          container access within jobs
    \item Improved internal monitoring with custom Grafana dashboards
    \item Implemented backend and frontend for new pages in Ruby on Rails \& HAML
